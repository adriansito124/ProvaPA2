...
export const Menu:React.FC<IMenu> = ({op1, op2, op3}) => {
    ...
    const style =
    {
        p: "bg-slate-700 px-2 py-1 min-w-20 w-1/12 text-branco text-lg cursor-pointer border rounded-2xl text-white font-medium hover:scale-105 transition duration-150 ease-in-out",
